...
import useFetchBrowseMovies from "@/hooks/customer/browse-movies/useFetchBrowseMovies";
import useFetchCitiesGlobal from "@/hooks/customer/cities/useFetchCitiesGlobal";
import useFetchGenresGlobal from "@/hooks/customer/genres/useFetchGenresGlobal";
import useFetchTheatersGlobal from "@/hooks/customer/theaters/useFetchTheatersGlobal";
import { useAppSelector } from "@/redux/hooks";
import { Film } from "lucide-react";
import { useParams } from "next/navigation";

const BrowseGenre = () => {
  const { genres } = useFetchGenresGlobal();
  const { cities } = useFetchCitiesGlobal();
  const { theaters } = useFetchTheatersGlobal();
